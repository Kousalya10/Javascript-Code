...
// Pass by value 
// the actual value(copy) of the variable is passed to the function, in this scenario , 
//modifications are made to the parameter inside the function do not affect the original value outside the function 
...
// Pass by refrence 
// the memory address(reference) of the variable is passed to the function,
// modification made to the paramete inside the function directly affect the original value.
