...
const person={
    ...
    function getname(company,designation)
    {
        console.log(this.firstname+" " + this.lastname+"  Working in  "+ `${company}  as a ${designation}`)
    }
    getname.call(person,"TCS","Developer")
    getname.apply(person,["TCS","Developer"])
    const fullname=getname.bind(person)
    fullname("Amazon","Developer")
// console.log('working ');
...
// const getname =(company,designation) =>
// {
//     console.log(person.firstname+" " + person.lastname+"  Working in  "+ `${company}  as a ${designation}`)
// }
// getname.call(person,"TCS","Developer")
// getname.apply(person,["TCS","Developer"])
// const fullname=getname.bind(person)
